    ...
    >
      <div className="flex justify-start items-center  ">
        ...
        <div className="text-3xl font-extrabold ">
          <span className="text-green-500 underline decoration-3 ">Food</span>
          <span className="text-red-400 underline decoration-3 ">Favor</span>
        </div>
      </div>
      ...
      <div className="text-lg flex flex-col justify-around items-center gap-10 ">
        ...
        <div className="text-gray-500 text-base">
          ...
          towards conscious and impactful living. Embrace FoodFavor and savor
      ...
      <div className="w-full flex gap-5 flex-col justify-start items-center bg-gray-100 rounded-3xl">
        <div className="w-full flex justify-start items-center  gap-2">
          ...
          <div className="text-xl text-black">
            <p>Sara Joy</p>
            <p className="text-sm text-gray-800">Cooking Enthusiast</p>
          </div>
        </div>
        <div className="px-4 pb-4 text-sm text-gray-700">
          FoodFavor has transformed the way I cook! Sharing recipes with fellow
