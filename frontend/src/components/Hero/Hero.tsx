...
const Hero = () => {
  return (
    <div className="mx-auto m-10 flex gap-24 justify-evenly  items-center h-[75vh] ">
      <div className="p-4 flex flex-col gap-5 justify-center w-1/2 ">
        ...
        <p className="text-wrap text-gray-500 text-lg">
          FoodFavor is a user-friendly application designed to simplify
          sustainability in your daily culinary journey. FoodFavor transforms
